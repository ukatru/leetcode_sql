...
| user_id     |  name        |
+-------------+--------------+
insert into users_1341 values(1,'Daniel');
insert into users_1341 values(2,'Monica');
insert into users_1341 values(3,'Maria');
insert into users_1341 values(4,'James');
+-------------+--------------+
MovieRating table:
+-------------+--------------+--------------+-------------+
...
create table movies (movie_id int, title varchar(50));

create table users_1341 (user_id int, name varchar(50));
