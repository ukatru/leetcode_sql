...
and was sold at day 5 for 500$. At last, it was bought at day 6 for 1000$ and was sold at day 10 for 10000$. Capital gain/loss is 
the sum of capital gains/losses for each ('Buy' --> 'Sell') operation = (1010 - 10) + (500 - 1000) + (10000 - 1000) = 1000 - 500 + 9000 = 9500$.
...
with t as (select stock_name,case when operation='Buy' then price else 0 end as buy_price,
case when operation='Sell' then price else 0 end as sell_price
from stocks
)
select stock_name,(sum(sell_price) - sum(buy_price)) capital_gain_loss  from t
group by stock_name